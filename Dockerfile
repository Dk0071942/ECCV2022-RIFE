...
RUN apt-get update && apt-get install -y git wget xz-utils libgl1 libglib2.0-0 libsm6 libxext6 libxrender1 build-essential python3 python3-pip python3-dev curl --no-install-recommends \
